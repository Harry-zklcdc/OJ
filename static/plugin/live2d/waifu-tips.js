...
// 后端接口
live2d_settings['modelAPI']             = 'https://api.pkupi.com/live2d/';   // 自建 API 修改这里
live2d_settings['tipsMessage']          = 'waifu-tips.json';            // 同目录下可省略路径
live2d_settings['hitokotoAPI']          = 'lwl12.com';                  // 一言 API，可选 'lwl12.com', 'hitokoto.cn', 'jinrishici.com'(古诗词)

// 默认模型
live2d_settings['modelId']              = 25;            // 默认模型 ID，可在 F12 控制台找到
...
//看板娘样式设置
live2d_settings['waifuSize']            = '210x200';    // 看板娘大小，例如 '280x250', '600x535'
